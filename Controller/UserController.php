...
use Mesd\UserBundle\Form\Type\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository($userClass)->findAll();

        return $this->render('MesdUserBundle:User:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        return $this->render('MesdUserBundle:User:show.html.twig', array(
            'entity'      => $entity,
