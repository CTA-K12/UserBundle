                ...
                ->arrayNode('register')
                    ...
                    ->children()
                        ...
                        ->arrayNode('template')
                            ...
                            ->children()
                                ->scalarNode('approve')
                                    ->defaultValue('MesdUserBundle:Register:approve.html.twig')
                                ->end()
                                ->scalarNode('approval_mail')
                                    ->defaultValue('MesdUserBundle:Register:approvalEmail.txt.twig')
                                ->end()
                                ->scalarNode('confirm')
                                    ->defaultValue('MesdUserBundle:Register:confirm.html.twig')
                                ->end()
                                ->scalarNode('confirm_mail')
                                    ->defaultValue('MesdUserBundle:Register:confirmEmail.txt.twig')
                                ->end()
                                ->scalarNode('register')
                                    ->defaultValue('MesdUserBundle:Register:register.html.twig')
                                ->end()
                                ->scalarNode('summary')
                                    ->defaultValue('MesdUserBundle:Register:summary.html.twig')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
