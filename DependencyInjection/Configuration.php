                    ...
                    ->children()
                        ...
                        ->arrayNode('template')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('edit')
                                    ->defaultValue('MesdUserBundle:Filter:edit.html.twig')
                                ->end()
                                ->scalarNode('new')
                                ...
                                ->end()
                                ->scalarNode('eachuser')
                                    ->defaultValue('MesdUserBundle:Filter:eachuser.html.twig')
                                ->end()
                                ->scalarNode('allusers')
                                    ->defaultValue('MesdUserBundle:Filter:allusers.html.twig')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
